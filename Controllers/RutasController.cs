...
namespace RutasCheck.Controllers
{
    ...
    public class RutasController : Controller
    {
        ...
        public RutasController(RutasCheckContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdRuta,Nombre,Color")] Ruta ruta)
        {
            if (id != ruta.IdRuta)
            {
                return NotFound();
        ...
        private  DetalleRuta CreateDetalleRuta(Ruta ruta){
            var FechaInicio = DateTime.Now;

            var detalleRuta = new DetalleRuta(){
                IdRutaNavigation = ruta,
