...
namespace RutasCheck.Migrations
{
    ...
    [Migration("20200616200939_add_Parada_table")]
    partial class add_Parada_table
    {
            ...
            modelBuilder.Entity("RutasCheck.Models.Recorrido", b =>
                {
                    ...
                    b.HasIndex("IdParadaDetalleRuta")
            ...
            modelBuilder.Entity("RutasCheck.Models.Recorrido", b =>
                {
                    ...
                    b.HasOne("RutasCheck.Models.ParadaDetalleRuta", "IdParadaNavigation")
                        .WithMany("Recorridos")
                        .HasForeignKey("IdParadaDetalleRuta")
